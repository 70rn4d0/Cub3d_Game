...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/02 09:02:34 by aech-chi          #+#    #+#             */
/*   Updated: 2025/05/03 13:48:52 by yabdoul          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "head.h"

static int	process_configuration_phase(char *line, t_parsing_data *data,
			bool *configs_done)
{
...
static int	process_map_phase(char *line, t_parsing_data *data)
{
...
static int	process_line(char *line, t_parsing_data *data, bool *configs_done)
{
	if (!*configs_done)
	{
