...
/*   Updated: 2025/05/03 10:37:04 by yabdoul          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	process_rgb_values(t_parsing_data *data, char **rgb, bool is_floor)
{
	if (is_floor)
	{
...
static void	parse_rgb_string(t_parsing_data *data, char *rgb_str, bool is_floor)
{
	char	**rgb;
	int		i;
