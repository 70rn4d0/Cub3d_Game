...
/*   Updated: 2025/04/27 16:41:54 by yabdoul          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "head.h"

int	check_invalid_chars(t_parsing_data *data)
{
	int	i;
	int	j;
...
int	check_inner_empty_lines(t_parsing_data *data)
{
	int		i;
	bool	map_started;
	bool	map_ended;
...
int	check_pos(t_parsing_data *map, int x, int y, char *invalid_neighbors)
{
...
int	map_is_closed(t_parsing_data *map, int x, int i, char *valid_neighbors)
{
	i = 0;
